		...
		<div class="wrap_content">
			<form id="fm" method="post" action="${pageContext.request.contextPath }/product/update_myproduct" enctype="multipart/form-data">
				...
				<div class="product_psumnail">
					...
					<input type="file" name="pSumnail" id="pSumnail" name="pSumnail"  accept="image/jpeg,png">
				</div>
				...
				<div class="product_notice">
					...
					<input type="file" id="notice_img" name="notice_img" multiple="multiple" accept="image/jpeg,png">
				</div>
				...
				<div class="product_info">
					...
					<input type="file" id="info_img" name="info_img" multiple="multiple" accept="image/jpeg,png">
				</div>
					...
					<table>
						<tbody>
							<tr>
								...
								<td><input type="text" id="price"  name="price" placeholder="숫자만 입력해주세요" value="${pdto.pRice }" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" ></td>
							</tr>
							<tr>
