				...
				<form name="frm"  method="post" enctype="multipart/form-data">
					<table>
						<tr>
							<td>업체명</td>
							<td>
								<input type="text" name="bdeptname" id="bdeptname">
							</td>
						</tr>
						<tr>
							<td>담당자</td>
							<td><input type="text" name="bmanager" id="bmanager"></td>
						</tr>
						<tr>
							<td>연락처</td>
							<td><input type="text" name="bmanager_number" id="bmanager_number"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td>
						</tr>
						<tr>
							<td>종료일</td>
							<td>
								<input type="date" name="bdate" id="bdate" style="color:black">
							</td>
						</tr>
						<tr>
							<td>이미지</td>
						...
						<tr>
							<td colspan="2">
								<input type="button" name="submit_btn" id="submit_btn" value="등록">
				...
				$().ready(function(){
					...
					$('#submit_btn').click(function(){
						...
						if(bdeptname ==''){
							...
							$.ajax({
								url:'${pageContext.request.contextPath}/admin/insert_newBanner',
								type:'post',
								...
								success:function(data){
									...
									alert('등록되었습니다.');
									opener.history.go(0);
									location.href='${pageContext.request.contextPath}/admin/showBanner?bidx='+data;
