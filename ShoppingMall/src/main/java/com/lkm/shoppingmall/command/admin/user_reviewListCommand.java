...
public class user_reviewListCommand implements command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		rlist =adao.rlist(data);
		totalCount = adao.review_total(data);
		
		String pageMaker = PageMaker.getPageView2("user_review?uidx="+uidx , page, recordPerPage, totalCount);
