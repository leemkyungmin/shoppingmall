...
public class user_customerListCommand implements command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		String pageMaker = PageMaker.getPageView2("user_customer_svc?uidx="+uidx , page, recordPerPage, totalCount);
