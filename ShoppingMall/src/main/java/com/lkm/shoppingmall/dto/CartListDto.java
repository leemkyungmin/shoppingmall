...
public class CartListDto {
	...
	int pIdx,cIdx,dIdx,pOrder_price,cPrice,cTotal_Count;
	...
	public CartListDto(int pIdx, int cIdx, int dIdx, int pOrder_price, int cPrice, int cTotal_Count, String dName,
			String cName, String pName, String pSumnail) {
		super();
		this.pIdx = pIdx;
		this.cIdx = cIdx;
		this.dIdx = dIdx;
